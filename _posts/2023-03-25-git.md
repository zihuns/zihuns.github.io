...
- About MR
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_1.png)
...
- HEAD와 Branch의 관계
    ...
    ![기본적인 HEAD와 브랜치의 관계](/assets/img/git/2025-01-25-GIT_CMD_2.png)
...
- Checkout(심화)
    ...
    ![HEAD가 9033 커밋을 가리키고 있다.(Detached HEAD 상태)](/assets/img/git/2025-01-25-GIT_CMD_3.png)
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_4.png)
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_5.png)
    
    그리고 이렇게 HEAD가 premium 브랜치를 가리키는 상태일 때 **새 커밋**을 하면
    
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_6.png)
...
- Commit
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_7.png)
...
- Reset
    ...
    **HEAD^**는 현재 HEAD가 가리키고 있는 커밋의 바로 이전 커밋을 나타냅니다. 
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_8.png)
    
    ### **git reset을 하고 나서 되돌아오려면?**
    
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_9.png)
    
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_10.png)
...
- Revert
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_11.png)
...
- Cherry-pick
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_12.png)
...
- Stash
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_13.png)
...
- Alias
    ...
    ![/assets/img/git/2025-01-25-GIT_CMD_1](/assets/img/git/2025-01-25-GIT_CMD_14.png)
