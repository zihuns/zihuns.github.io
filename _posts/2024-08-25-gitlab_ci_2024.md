...
![MR 알림 on/off](/assets/img/gitlab_ci_2024/gitlab_ci_2024_mr_notification_toggle.png)
![MR 알림 Draft 예시](/assets/img/gitlab_ci_2024/gitlab_ci_2024_mr_draft_example.png)
![MR 알림 Ready 예시](/assets/img/gitlab_ci_2024/gitlab_ci_2024_mr_ready_example.png)

### 2-2. 대상 그룹 호출
MR 생성 시 labels에서 @here, @fsd_display, @fsd_search 등 원하는 그룹을 선택하면 해당 그룹이 슬랙 메시지에서 호출됩니다.
![대상 그룹 호출 예시2](/assets/img/gitlab_ci_2024/gitlab_ci_2024_group_mention_example.png)
