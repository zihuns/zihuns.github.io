...
![Swagger API 호출](/assets/img/msw_2/msw_2_swagger_api_call.png)  
![스키마 파싱 과정](/assets/img/msw_2/msw_2_schema_parsing.png)  
![Tag 단위 저장 기능](/assets/img/msw_2/msw_2_tag_save.png)  
![배열 요소 옵션](/assets/img/msw_2/msw_2_array_options.png)  
![최종 결과 화면](/assets/img/msw_2/msw_2_final_result.png)  
